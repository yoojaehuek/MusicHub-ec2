  ...
  return (
    <div className="sliders">
      ...
      <Sliders {...settings} className="sliders2">
        <div>
          <img
            ...
            alt="이미지"
            src={API_URL+"/images/video/ge.jpg"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/video/ge2.jpg"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/video/ge3.jpg"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/video/ge4.jpg"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/video/ge5.jpg"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/video/ge6.jpg"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/video/ge7.jpg"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/video/ge8.jpg"}
          />
          <br></br>
      ...
      >
        ...
        >
          <img
            src={API_URL+"/images/video/gbl.png"}
            alt="감상 이미지"
