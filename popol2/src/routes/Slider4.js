  ...
  return (
    <div className="sliders">
      ...
      <Sliders {...settings} className="sliders2">
        <div>
          <img
            ...
            alt="이미지"
            src={API_URL+"/images/slider3/1.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider3/2.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider3/3.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider3/4.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider3/5.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider3/6.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider3/7.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider3/8.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider3/9.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider3/10.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider3/11.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider3/12.png"}
          />
          <br></br>
      ...
      >
        ...
        >
          <img
            src={API_URL+"/images/slider3/Di.png"}
            alt="감상 이미지"
