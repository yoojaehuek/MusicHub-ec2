  ...
  return (
    <div className="sliders">
      ...
      <Sliders {...settings} className="sliders2">
        <div>
          <img
            ...
            alt="이미지"
            src={API_URL+"/images/slider2/1.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider2/2.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider2/3.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider2/4.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider2/5.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider2/6.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider2/7.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider2/8.png"}
          />
          <br></br>
        ...
        <div>
          <img
            className="phoneImages"
            alt="이미지"
            src={API_URL+"/images/slider2/9.png"}
          />
          <br></br>
      ...
      >
        ...
        >
          <img
            src={API_URL+"/images/slider2/comix.png"}
            alt="감상 이미지"
